...
class Solution {
    Node LCA(Node root, Node n1, Node n2) {
        // your code here.
        if(n2.data<n1.data) return LCA(root,n2,n1);
        else return solve(root,n1,n2);
    }
    Node solve(Node root, Node n1, Node n2){
        if(root==null) return null;
        else if(n1.data<=root.data && root.data<=n2.data) return root;
        else if(n1.data> root.data) return solve(root.right,n1,n2);
